...
HELP = """usage: hmm [serve options] | hmm serve [options] | hmm <command> [options]

hmm local listening daemon and AKOUO harness.

daemon:
  hmm --profile mac-mps --host 127.0.0.1 --port 8765
  hmm serve --profile stub
...
Legacy `aear` command aliases are still installed for existing scripts.
"""
...
def main() -> None:
    ...
    if args and args[0] == "serve":
        from aear.server import main as server_main
