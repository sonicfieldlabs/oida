...
def system_audio_status(platform: str | None = None) -> SystemAudioStatus:
    ...
    if platform == "darwin":
        return SystemAudioStatus(
            ...
            summary="macOS system output can be routed into hmm today by selecting a virtual loopback device as live input.",
            setup_steps=[
                ...
                "Grant browser microphone permission and choose the loopback device in hmm's live source selector.",
