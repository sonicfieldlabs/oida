...
This module is the perception floor of oida: it always has something honest to
...
BASIS = "oida signal listener: deterministic heuristics over measured DSP features"
