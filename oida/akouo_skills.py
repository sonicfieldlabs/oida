...
SKILL_MANIFEST_SCHEMA: dict[str, Any] = {
    ...
    "$id": "https://sonic-field.local/oida/akouo-listening-skill.schema.json",
...
ROUTE_PRESET_SCHEMA: dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "$id": "https://sonic-field.local/oida/akouo-route-preset.schema.json",
...
SKILLS: list[ListeningSkillManifest] = [
    ...
    ListeningSkillManifest(
        ...
        input_requirements={"acceptsFile": True, "acceptsStream": True},
        model_requirements=["moss-audio", "oida-dsp"],
        memory_policy="write",
        ui_card="hypotheses",
    ),
    ListeningSkillManifest(
